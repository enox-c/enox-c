...
The Enox Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Enox Core project, and is not to be
confused with overall Enox Network Protocol consensus changes.

Whether a pull request is merged into Enox Core rests with the project merge
...
Patches that change Enox consensus rules are considerably more involved than
...
Where a patch set proposes to change the Enox consensus, it must have been
