...
In order to support loading of multiple wallets in enox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is enox.cpp.
...
Changes to enox.cpp
----------------------
enox.cpp is the entry point into enox-qt, and as such, will require some minor modifications to provide hooks for
