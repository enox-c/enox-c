...
This mechanism has been integrated into Bitcore-Node-Enox which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/enoxpay/insight-api-enox#web-socket-api](https://github.com/enoxpay/insight-api-enox#web-socket-api)
* API: [https://github.com/enoxpay/insight-api-enox#instantsend-transactions](https://github.com/enoxpay/insight-api-enox#instantsend-transactions)
...
By default, the Enox Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Enox Core daemon:
