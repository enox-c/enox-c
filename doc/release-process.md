...
* Update translations, see [translation_process.md](https://github.com/enoxpay/enox/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/enoxpay/gitian.sigs.git
	git clone https://github.com/enoxpay/enox-detached-sigs.git
	git clone https://github.com/devrandom/gitian-builder.git
	git clone https://github.com/enoxpay/enox.git

### Enox Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign Enox Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit enox=v${VERSION} ../enox/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit enox=v${VERSION} ../enox/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit enox=v${VERSION} ../enox/contrib/gitian-descriptors/gitian-osx.yml
...
### Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../enox/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [enox-detached-sigs](https://github.com/enoxpay/enox-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the enox.org server

- Update enox.org

- Announce the release:

  - Release on Enox forum: https://www.enox.org/forum/topic/official-announcements.54/

  - Enox-development mailing list

  - Update title of #enoxpay on Freenode IRC

  - Optionally reddit /r/Enoxpay, ... but this will usually sort out itself

- Notify flare so that he can start building [the PPAs](https://launchpad.net/~enox.org/+archive/ubuntu/enox)
