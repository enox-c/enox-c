    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ENX-light"), QVariant("light"));
    ui->theme->addItem(QString("ENX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ENX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ENX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ENX-traditional"), QVariant("trad"));
