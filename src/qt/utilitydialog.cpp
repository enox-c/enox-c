    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Enox Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Enox Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  enox-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Enox in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ENX, 0.1 ENX, 1 ENX and 10 ENX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://enoxpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://enoxpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Enox Core is shutting down...") + "<br /><br />" +
