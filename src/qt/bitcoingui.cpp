...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Enox Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Enox"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Enox Core help message to get a list with possible Enox command-line options"));
