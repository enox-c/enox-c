    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Enox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Enox address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and enox: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Enox Core"), this);
    aboutAction->setStatusTip(tr("Show information about Enox Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Enox Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Enox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Enox addresses"));
    ...
    openAction->setStatusTip(tr("Open a enox: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Enox Core help message to get a list with possible Enox Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Enox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Enox network", "", count));
    } else {
...
{
    QString strTitle = tr("Enox Core"); // default title
