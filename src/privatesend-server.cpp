...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Enox related functionality
...
/*
    ...
    allow endless transaction that would bloat Enox and make it unusable. To
