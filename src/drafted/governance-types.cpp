...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EnoxNetwork") type = EnoxNetwork;
    if(strType == "EnoxNetworkVariable") type = EnoxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EnoxNetwork) s = "EnoxNetwork";
    if(type == EnoxNetworkVariable) s = "EnoxNetworkVariable";
