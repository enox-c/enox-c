 ...
 *
 *   // network
 *   CEnoxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.enox.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEnoxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EnoxNetwork
// //   -- signature requirements : Key1(User)
// class CEnoxNetworkVariable : public CGovernanceObject
// {
// private:
